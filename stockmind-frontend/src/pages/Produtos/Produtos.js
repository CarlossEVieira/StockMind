...
export default function Produtos() {
    ...
    async function excluirProduto(idProduto) {
        const confirmouExclusao = window.confirm("Deseja realmente excluir este produto?");
    ...
    const produtosFiltrados = useMemo(() => {
        return produtos.filter((produto) => {
            ...
            const atendeBusca = nomeProduto.includes(textoBuscaFormatado);
    ...
    }, [produtos, textoBusca, categoriaSelecionada]);
